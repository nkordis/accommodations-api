...
{
    public class UpdateAccommodationCommandHandler(ILogger<CreateAccommodationCommandHandler> logger, 
        IMapper mapper, IAccommodationsRepository accommodationsRepository) : IRequestHandler<UpdateAccommodationCommand, bool>
    {
        ...
        {
            logger.LogInformation($"Updating accommodation with id {request.Guid}");
